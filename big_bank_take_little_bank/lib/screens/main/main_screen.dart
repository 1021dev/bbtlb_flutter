...
//            if (state is MainScreenLoadState) {
//              BlocProvider.of<DailyRewardsBloc>(context)..add(CheckDailyRewards());
//              showCupertinoDialog(
//                  context: context, builder: (BuildContext context) {
//                return CupertinoAlertDialog(
//                  title: Text('Oops'),
...
//                    screenBloc: BlocProvider.of<DailyRewardsBloc>(context),
//                  );
//                },
//              );
//            }
...
//          BlocProvider<DailyRewardsBloc>(
//            create: (BuildContext context) {
//              return DailyRewardsBloc(DailyRewardsInitState())..add(CheckDailyRewards());
//            },
//          ),
//          BlocProvider<MainScreenBloc>(
//            create: (BuildContext context) {
//              return MainScreenBloc(MainScreenInitState())..add(MainScreenInitEvent());
//            },
//          ),
//        ],
//        child: MainScreenContent(),
