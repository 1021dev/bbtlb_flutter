...
class AdsRewardsDialog extends StatefulWidget {
  final BuildContext homeContext;
  final RewardsModel rewardsModel;
  const AdsRewardsDialog({Key key, this.homeContext, this.rewardsModel}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _AdsRewardsDialogState(homeContext);
  }
}

class _AdsRewardsDialogState extends State<AdsRewardsDialog> {
  RewardsModel rewardsModel;
  final BuildContext homeContext;
  _AdsRewardsDialogState(this.homeContext);

  @override
  void initState() {
    rewardsModel = widget.rewardsModel;
    super.initState();
  }
                      ...
                      children: [
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              AppButtonLabel(
                                title: 'Ads Rewards ${rewardsModel.consecutive + 1}',
                                fontSize: 24,
                                shadow: true,
                              ),
                              AppButtonLabel(
                              ...
                              children: [
                                ...
                                Positioned(
                                  ...
                                  child: AppBorderLabel(
                                    title: '\$${rewardsModel.rewardPoint}',
                                    fontFamily: 'Lucky',
